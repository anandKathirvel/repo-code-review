...
public class MC_EKYC_PrimaryDocs {
	/**
	 * -------------- METHOD - readExcelData - Login ----------------
	 */
	public static Triplet<String[][], Integer, Integer> readExcelData_Login() throws IOException {
		String filePath = "C:\\Users\\Anand\\OneDrive - Transtrac Technology Services Private Limited\\CODING\\CPBS_UI_Automation\\Testing_Selenium_Inputs\\EKYC_UI_Input_PrimaryDocs.xlsx";
//		if file
...
//		if file
	...
	public static void main(String[] args) {
		try {
			 ...
			 * ---------------* Driver Setup ---------------
			 */
//			String var_Driver_Path = "C:\\Users\\Anand\\OneDrive - Transtrac Technology Services Private Limited\\CODING\\CPBS_UI_Automation\\Dependency_Browser_Drivers\\chromedriver.exe";
			 ...
			 * ---------------* Initialize Variable ---------------
			 */
			int T1 = 1000, T2 = 2000, T3 = 3000, T4 = 4000, T5 = 5000; // Thread value
			...
			var_Sales_Super_Merchant, var_Sales_Group_Merchant, var_Sales_Region, var_Sales_Bank_Name, var_Sales_Bank_MID,
			var_Sales_DSA_Distributor, var_Sales_Person, var_Sales_Subvention_Type, var_Sales_Partner_Sharing, var_Sales_Loan_Reimbursement;

			// Company-Info
			String var_Comp_Legal_Name, var_Comp_Brand_Name, var_Comp_Registered_Address, var_Comp_Registered_Pincode, var_Comp_State, var_Comp_City,
			var_Comp_Type_of_Business, var_Comp_Establised_Year, var_Comp_Registered_Number, var_Comp_Company_Pan, var_Comp_GSTIN,
			var_Comp_Turnover_Year, var_Comp_Turnover_Amount, var_Comp_Nature_of_Business, var_Comp_MCC, var_Comp_Merchant_Type,
			var_Comp_Contact_Name, var_Comp_Mobile, var_Comp_Alternate_Mobile, var_Comp_Telephone, var_Comp_Email,
			var_Comp_Statement_Frequency, var_Comp_Statement_Type, var_Comp_Statement_Email_Required, var_Comp_Statement_Email_ID;

			// Personal-Info
			String var_Prsnl_Honorific, var_Prsnl_First_Name, var_Prsnl_Last_Name, var_Prsnl_DOB, var_Prsnl_Address, var_Prsnl_Pincode, var_Prsnl_State, var_Prsnl_City,
			var_Prsnl_Mobile, var_Prsnl_Telephone, var_Prsnl_EMail, var_Prsnl_Pan, var_Prsnl_Nationality, var_Prsnl_Aadhar_Number,
			var_Prsnl_Passport_Number, var_Prsnl_Passport_Exp_Date, var_Prsnl_Own_House, var_Prsnl_Add_Partner;

			// Risk-Info
			String var_Risk_Weekdays_from, var_Risk_Weekdays_to, var_Risk_Weekends_from, var_Risk_Weekends_to, var_Risk_Expected_Card_Business,
			var_Risk_Average_Bill_Amount, var_Risk_Velocity_Check_Minutes, var_Risk_Velocity_Check_Count, var_Risk_Settlement_Days,
			var_Risk_Cibil_Score, var_Risk_Merchant_Type_Code, var_Risk_International_Card_Acceptance, var_Risk_International_Daily, var_Risk_International_Weekly, var_Risk_International_Monthly, var_Risk_Name_of_POS,
			var_Risk_Member_Since, var_Risk_Current_MDR, var_Risk_AEPS_Daily, var_Risk_AEPS_Weekly, var_Risk_AEPS_Monthly, var_Risk_AEPS_Minimum, var_Risk_AEPS_Maximum, var_Risk_UPI_Daily,
			var_Risk_UPI_Weekly, var_Risk_UPI_Monthly, var_Risk_UPI_Minimum , var_Risk_UPI_Maximum, var_Risk_MicroATM_Daily, var_Risk_MicroATM_weekly, var_Risk_MicroATM_Monthly,
			var_Risk_MicroATM_Minimum, var_Risk_MicroATM_Maximum, var_Risk_POS_Daily, var_Risk_POS_Weekly, var_Risk_POS_Monthly, var_Risk_POS_Minimum, var_Risk_POS_Maximum ;

			// Bank-Info
			String var_Bank_Acct_Type, var_Bank_Acct_number, var_Bank_IFSC_code ;

			// Terminals
			String var_Terminal_Location, var_Terminal_Address, var_Terminal_Pincode, var_Terminal_Sim_Number, var_Terminal_Terminal_Type, var_Terminal_Device_Model,
			var_Terminal_Device_Owned, var_Terminal_Device_Price, var_Terminal_Installation_Fee, var_Terminal_Rental_Plan, var_Terminal_Rental_Type, var_Terminal_Rental_Mode, var_Terminal_Rental_Start_Date,
			var_Terminal_Rental_Threshold,var_Terminal_Maximum_Usage_Daily, var_Terminal_Maximum_Usage_Weekly,var_Terminal_Maximum_Usage_Monthly, var_Terminal_Velocity_Check_Minutes, var_Terminal_Velocity_Check_Count;

			// KYC-Info
			// **Primary Docs
			String var_KYC_Proof_Drive_Link, var_KYC_PAN_Doc_Num, var_KYC_Businees_Addr_Doc_Num, var_KYC_Aadhaar_Doc_Num, var_KYC_Bank_Cancel_Cheque_Doc_Num, var_KYC_Latest_Photo_Doc_Num, var_KYC_Aggr_Merchant_Aggrement_Doc_Num;
			// **Secondary Docs
			String var_KYC_PAN_Proof_Link, var_KYC_Business_Addr_Proof_Link, var_KYC_Aadhar_Proof_Link, var_KYC_Bank_Cancel_Cheque_Proof_Link, var_KYC_Latest_Pic_Proof_Link, var_KYC_Merchant_Aggrement_Proof_Link;
			...
			for (int i = 1; i <= var_rowCount_Login; i++) {
				...
				Thread.sleep(T2);
				driver.findElement(By.xpath("//span[contains(text(),'Merchant Management')]")).click(); // Merchant_Mgmt
				// MENU : Merchants(sub-menu)
				Thread.sleep(T1);
				driver.findElement(By.xpath("//span[contains(text(),'Merchants')]")).click(); // Merchants
				...
				for (int x = 5; x <= var_rowCount_MerchantOnboard; x++) {
					...
					var_KYC_Proof_Drive_Link = String.valueOf(var_data_MerchantOnboard[x][138].trim()); // Folder OR Drive link
...
//					 */
					...
					if (var_Sales_Agg_App_No.equalsIgnoreCase("Any")) {
						...
						driver.findElement(By.name("sales_information[aggregator_application_number]"))
								.sendKeys(var_Sales_Agg_App_No);
					} else {
						driver.findElement(By.name("sales_information[aggregator_application_number]"))
								.sendKeys(var_Sales_Agg_App_No);
					}
					...
					// FIELD 4 : Aggregator
					driver.findElement(By.xpath("//span[@aria-labelledby = 'select2-js_aggregator-select2-container']"))
							.click(); // click the field
					Thread.sleep(T3);

					driver.findElement(By.xpath("//input[@aria-controls='select2-js_aggregator-select2-results']"))
						.sendKeys(var_Sales_Aggregator);
...
//					driver.findElement(By.xpath("//span[@id='select2-js_super-merchant-select2-container']")).click();
//					Thread.sleep(T2);
//					driver.findElement(By.xpath("//li[normalize-space()='" + var_Sales_Super_Merchant + "']")).click();
//					System.out.println("var_Sales_Super_Merchant  = " + var_Sales_Super_Merchant);
...
//					driver.findElement(By.xpath("//span[@id='select2-js_group-merchant-select2-container']")).click();
//					Thread.sleep(T2);
//					driver.findElement(By.xpath("//li[normalize-space()='" + var_Sales_Group_Merchant + "']")).click();
//					System.out.println("var_Sales_Group_Merchant  = " + var_Sales_Group_Merchant);
...
//							System.out.println("\t ELSE ANY - EXIT");
					...
					/*
					 * Field 10 - 27 were assigned to Sales-Info input fields but code was NOT IMPLEMENTED yet.
					...
					Thread.sleep(T3);
					System.out.println(
							"\t< Sales-Info > POP-UP Status = " + driver.findElement(By.id("swal2-title")).getText());
...
//					Flu_Wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[normalize-space()='OK']"))).click();
					...
					Thread.sleep(T2);
					driver.findElement(By.xpath("//input[@aria-controls='select2-js_pincode-select2-results']"))
							.sendKeys(var_Comp_Registered_Pincode);
					Thread.sleep(T1);
					driver.findElement(
...
//					System.out.println("var_Estb_Date = " + var_Estb_Date);
					...
					// Field : 38 --> GSTIN
					driver.findElement(By.xpath("//input[@name='company_information[gstin]']")).sendKeys(var_Comp_GSTIN);
					...
					Thread.sleep(T5);
					driver.findElement(By.xpath("//span[@aria-labelledby='select2-js_merchant-type-select2-container']")).click();
					Thread.sleep(T5);
...
//					driver.findElement(By.xpath("(//span[@class='select2-results'])[1]/ul/li[19]")).click();
					...
					if (var_login_Username.equalsIgnoreCase("ucpbsmaster")) {
						...
						if (var_Comp_Statement_Email_Required.equalsIgnoreCase("Yes")) {
							...
							driver.findElement(By.xpath("//label[normalize-space()='Statement Email Required']"))
									.click();
							System.out.println("var_Comp_Statement_Email_Required \t\t = " + var_Comp_Statement_Email_Required);

							// Field : 52 --> Statement_Email_ID
							Thread.sleep(T1);
							driver.findElement(By.xpath("//input[@role='searchbox']")).sendKeys(var_Comp_Statement_Email_ID);
							driver.findElement(By.xpath("//li[contains(.,'" + var_Comp_Statement_Email_ID + "')]")).click();
					...
					Thread.sleep(T3);
					System.out.println(
							"\t< Company-Info > POP-UP Status = " + driver.findElement(By.id("swal2-content")).getText());
					driver.findElement(By.xpath("//button[normalize-space()='OK']")).click();
					...
					Thread.sleep(T1);
					driver.findElement(By.xpath("(//select[@name='personal_information[0][title]'])//option[@value='" + var_Prsnl_Honorific + "']")).click();

					System.out.println("var_Prsnl_Honorific \t\t = " + var_Prsnl_Honorific);


					// Field : 54 --> First Name
					driver.findElement(By.xpath("//input[@name='personal_information[0][first_name]']")).sendKeys(var_Prsnl_First_Name);
					System.out.println("var_Prsnl_First_Name \t\t = " + var_Prsnl_First_Name);


					// Field : 55 --> Last Name
					driver.findElement(By.xpath("//input[@name='personal_information[0][last_name]']")).sendKeys(var_Prsnl_Last_Name);
...
//					System.out.println("var_DOB_Year = " + var_DOB_Year);
					...
					// Processing DOB-Year
					Select dob_year_value = new Select(driver.findElement(By.xpath("//div[@class='drp-calendar left single']//select[@class='yearselect']")));
...
//					System.out.println("************ Before Click 1");
					Select dob_month_value = new Select(driver.findElement(By.xpath("//div[@class='drp-calendar left single']//select[@class='monthselect']")));
...
//					driver.findElement(By.xpath("//td[@class='available'][normalize-space()='16']")).click();
					...
					// Field : 57 --> Address
					driver.findElement(By.xpath("//input[@name='personal_information[0][address]']")).sendKeys(var_Prsnl_Address);
					System.out.println("var_Prsnl_Address \t\t = " + var_Prsnl_Address);


					// Field : 58 --> Pincode
//					Thread.sleep(T1);
					driver.findElement(By.xpath("(//span[@class='select2-selection select2-selection--single js_personal-pincode-select2 form-control'])[1]")).click();
					driver.findElement(By.xpath("//span[@class='select2-search select2-search--dropdown']//input[@role='searchbox']")).sendKeys(var_Prsnl_Pincode);
					Thread.sleep(T2);
					...
					// Field : 59 --> State
					System.out.println("var_Prsnl_State \t\t = " + driver.findElement(By.xpath("(//input[@class='form-control js_personal-state'])[1]")).getText());

					// Field : 60 --> City
					System.out.println("var_Prsnl_City \t\t\t = " + driver.findElement(By.xpath("(//input[@class='form-control js_personal-city'])[1]")).getText());

					// Field : 61 --> Mobile
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][mobile]']")).sendKeys(var_Prsnl_Mobile);
					System.out.println("var_Prsnl_Mobile \t\t = " + var_Prsnl_Mobile);


					// Field : 62 --> Telephone
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][phone]']")).sendKeys(var_Prsnl_Telephone);
					System.out.println("var_Prsnl_Telephone \t\t = " + var_Prsnl_Telephone);


					// Field : 63 --> Email
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][email]']")).sendKeys(var_Prsnl_EMail);
					System.out.println("var_Prsnl_EMail \t\t = " + var_Prsnl_EMail);


					// Field : 64 --> Pan
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][pan]']")).sendKeys(var_Prsnl_Pan);
...
//					driver.findElement(By.xpath("//input[@name='personal_information[0][nationality]']")).sendKeys(var_Prsnl_Nationality);
					System.out.println("var_Prsnl_Nationality \t\t = " + driver.findElement(By.xpath("//input[@name='personal_information[0][nationality]']")).getText());


					// Field : 66 --> Aadhar number
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][aadhar_number]']")).sendKeys(var_Prsnl_Aadhar_Number);
					System.out.println("var_Prsnl_Aadhar_Number \t = " + var_Prsnl_Aadhar_Number);


					// Field : 67 --> Passport Number
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][passport_number]']")).sendKeys(var_Prsnl_Passport_Number);
					System.out.println("var_Prsnl_Passport_Number \t = " + var_Prsnl_Passport_Number);


					// Field : 68 --> Passport Expiry Date
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='personal_information[0][passport_expiry_date]']")).sendKeys(var_Prsnl_Passport_Exp_Date);
					System.out.println("var_Prsnl_Passport_Exp_Date \t = " + var_Prsnl_Passport_Exp_Date);

					/*
					 * Field 69 - 70 were assigned to Personal-Info input fields but code was NOT IMPLEMENTED yet.
					 * var_Prsnl_Own_House => Field[60]
					 * var_Prsnl_Add_Partner => Field[70]
					 */
					...
					Thread.sleep(T3);
					System.out.println(
							"\t< Personal-Info > POP-UP Status = " + driver.findElement(By.id("swal2-content")).getText());
					driver.findElement(By.xpath("//button[normalize-space()='OK']")).click();
					...
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[weekday_start_hour]']")).sendKeys(var_Risk_Weekdays_from);
					System.out.println("var_Risk_Weekdays_from \t\t = " + var_Risk_Weekdays_from);


					// Field : 72 --> Business Hours - Weekdays To
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[weekday_end_hour]']")).sendKeys(var_Risk_Weekdays_to);
					System.out.println("var_Risk_Weekdays_to \t\t = " + var_Risk_Weekdays_to);

					// Field : 73 --> Business Hours - Weekends From
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[weekend_start_hour]']")).sendKeys(var_Risk_Weekends_from);
					System.out.println("var_Risk_Weekends_from \t\t = " + var_Risk_Weekends_from);

					// Field : 74 --> Business Hours - Weekends To
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[weekend_end_hour]']")).sendKeys(var_Risk_Weekends_to);
					System.out.println("var_Risk_Weekends_to \t\t = " + var_Risk_Weekends_to);

					// Field : 75 --> Expected Card Business
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[expected_card_business]']")).sendKeys(var_Risk_Expected_Card_Business);
					System.out.println("var_Risk_Expect_Card_Buss \t = " + var_Risk_Expected_Card_Business);

					// Field : 76 --> Average Bill Amount
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[average_bill_amount]']")).sendKeys(var_Risk_Average_Bill_Amount);
					System.out.println("var_Risk_Average_Bill_Amount \t = " + var_Risk_Average_Bill_Amount);

					// Field : 77 --> Velocity Check Minutes
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[velocity_check_minutes]']")).sendKeys(var_Risk_Velocity_Check_Minutes);
					System.out.println("var_Risk_Vlcty_Check_Mints \t = " + var_Risk_Velocity_Check_Minutes);

					// Field : 78 --> Velocity Check Count
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[velocity_check_count]']")).sendKeys(var_Risk_Velocity_Check_Count);
					System.out.println("var_Risk_Velocity_Check_Count \t = " + var_Risk_Velocity_Check_Count);

					// Field : 79--> Settlement Days
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[settlement_days]']")).sendKeys(var_Risk_Settlement_Days);
					System.out.println("var_Risk_Settlement_Days \t = " + var_Risk_Settlement_Days);

					// Field : 80--> Cibil Score
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[cibil_score]']")).sendKeys(var_Risk_Cibil_Score);
...
//					// Field : 82--> International Card Acceptance (Check-box)
					driver.findElement(By.xpath("//input[@id='internationalCardAcceptance']/following-sibling::label[contains(@for,'internationalCardAcceptance')]")).click();


					// Field : 83--> Daily
					Thread.sleep(T3);
					driver.findElement(By.xpath("//input[@name='risk_information[international_max_daily_usage]']")).sendKeys(var_Risk_International_Daily);
					System.out.println("var_Risk_International_Daily \t = " + var_Risk_International_Daily);


					// Field : 84--> Weekly
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[internatioanl_max_weekly_usage]']")).sendKeys(var_Risk_International_Weekly);
					System.out.println("var_Risk_International_Weekly \t = " + var_Risk_International_Weekly);

					// Field : 85--> Monthly
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[international_max_monthly_usage]']")).sendKeys(var_Risk_International_Monthly);
					System.out.println("var_Risk_International_Monthly \t = " + var_Risk_International_Monthly);

					// Field : 86--> Name of POS
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[current_pos_name]']")).sendKeys(var_Risk_Name_of_POS);
...
//							.getText());
					...
					Thread.sleep(T1);
					driver.findElement(By.xpath("//input[@name='risk_information[current_mdr]']")).sendKeys(var_Risk_Current_MDR);
					...
					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][0][daily_limit]']")).sendKeys(var_Risk_AEPS_Daily);
					System.out.println("var_Risk_AEPS_Daily \t\t = " + var_Risk_AEPS_Daily);

					// Field : 98--> AEPS Weekly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][0][weekly_limit]']")).sendKeys(var_Risk_AEPS_Weekly);
					System.out.println("var_Risk_AEPS_Weekly \t\t = " + var_Risk_AEPS_Weekly);

					// Field : 99--> AEPS Monthly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][0][monthly_limit]']")).sendKeys(var_Risk_AEPS_Monthly);
					System.out.println("var_Risk_AEPS_Monthly \t\t = " + var_Risk_AEPS_Monthly);

					// Field : 100--> AEPS Minimum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][0][minimum_amount]']")).sendKeys(var_Risk_AEPS_Minimum);
					System.out.println("var_Risk_AEPS_Minimum \t\t = " + var_Risk_AEPS_Minimum);

					// Field : 101--> AEPS Maximum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][0][maximum_amount]']")).sendKeys(var_Risk_AEPS_Maximum);
					System.out.println("var_Risk_AEPS_Maximum \t\t = " + var_Risk_AEPS_Maximum);

					// Field : 102--> UPI Daily

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][1][daily_limit]']")).sendKeys(var_Risk_UPI_Daily);
					System.out.println("var_Risk_UPI_Daily \t\t = " + var_Risk_UPI_Daily);

					// Field : 103--> UPI Weekly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][1][weekly_limit]']")).sendKeys(var_Risk_UPI_Weekly);
					System.out.println("var_Risk_UPI_Weekly \t\t = " + var_Risk_UPI_Weekly);

					// Field : 104--> UPI Monthly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][1][monthly_limit]']")).sendKeys(var_Risk_UPI_Monthly);
					System.out.println("var_Risk_UPI_Monthly \t\t = " + var_Risk_UPI_Monthly);

					// Field : 104--> UPI Minimum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][1][minimum_amount]']")).sendKeys(var_Risk_UPI_Minimum);
					System.out.println("var_Risk_UPI_Minimum \t\t = " + var_Risk_UPI_Minimum);

					// Field : 105--> UPI Maximum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][1][maximum_amount]']")).sendKeys(var_Risk_UPI_Maximum);
					System.out.println("var_Risk_UPI_Maximum \t\t = " + var_Risk_UPI_Maximum);

					// Field : 106--> MicroATM Daily

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][2][daily_limit]']")).sendKeys(var_Risk_MicroATM_Daily);
					System.out.println("var_Risk_MicroATM_Daily \t = " + var_Risk_MicroATM_Daily);

					// Field : 107--> MicroATM Weekly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][2][weekly_limit]']")).sendKeys(var_Risk_MicroATM_weekly);
					System.out.println("var_Risk_MicroATM_weekly \t = " + var_Risk_MicroATM_weekly);

					// Field : 108--> MicroATM Monthly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][2][monthly_limit]']")).sendKeys(var_Risk_MicroATM_Monthly);
					System.out.println("var_Risk_MicroATM_Monthly \t = " + var_Risk_MicroATM_Monthly);

					// Field : 109--> MicroATM Minimum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][2][minimum_amount]']")).sendKeys(var_Risk_MicroATM_Minimum);
					System.out.println("var_Risk_MicroATM_Minimum \t = " + var_Risk_MicroATM_Minimum);

					// Field : 110--> MicroATM Maximum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][2][maximum_amount]']")).sendKeys(var_Risk_MicroATM_Maximum);
					System.out.println("var_Risk_MicroATM_Maximum \t = " + var_Risk_MicroATM_Maximum);

					// Field : 110--> POS Daily

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][3][daily_limit]']")).sendKeys(var_Risk_POS_Daily);
					System.out.println("var_Risk_POS_Daily \t\t = " + var_Risk_POS_Daily);

					// Field : 110--> POS Weekly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][3][weekly_limit]']")).sendKeys(var_Risk_POS_Weekly);
					System.out.println("var_Risk_POS_Weekly \t\t = " + var_Risk_POS_Weekly);

					// Field : 110--> POS Monthly

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][3][monthly_limit]']")).sendKeys(var_Risk_POS_Monthly);
					System.out.println("var_R0isk_POS_Monthly \t\t = " + var_Risk_POS_Monthly);

					// Field : 110--> POS Minimum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][3][minimum_amount]']")).sendKeys(var_Risk_POS_Minimum);
					System.out.println("var_Risk_POS_Minimum \t\t = " + var_Risk_POS_Minimum);

					// Field : 110--> POS Maximum

					driver.findElement(By.xpath("//input[@name='risk_information[transaction_limits][3][maximum_amount]']")).sendKeys(var_Risk_POS_Maximum);
...
//					Flu_Wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[normalize-space()='OK']"))).click();
					...
					Thread.sleep(T1);
					driver.findElement(By.xpath("(//select[@name='bank_information[account_type]'])//option[@value='" + var_Bank_Acct_Type + "']")).click();

					System.out.println("var_Bank_Acct_Type \t = " + var_Bank_Acct_Type);


					// Field : 117 --> Bank Account Number
					driver.findElement(By.xpath("//input[@name='bank_information[account_number]']")).sendKeys(var_Bank_Acct_number);
					...
					driver.findElement(By.xpath("//span[@class='select2-search select2-search--dropdown']//input[@role='searchbox']")).sendKeys(var_Bank_IFSC_code);
					Thread.sleep(T2);
					driver.findElement(By.xpath("//li[@class='select2-results__option select2-results__option--highlighted']")).click();
...
//					driver.findElement(By.xpath("//a[@class='js_merchant-terminals-create-btn btn btn-outline-success mb-3 ld-ext-right float-right']")).click();
					driver.findElement(By.xpath("//div[@id='js_merchant-terminals']/div[1]/child::a[normalize-space()='Add Terminal']")).click();
...
//
					...
					Thread.sleep(T2);
					driver.findElement(By.xpath("//input[@aria-controls='select2-js_terminal-pincode-select2-results']"))
					...
					Thread.sleep(T3);
					driver.findElement(
							By.xpath("//span[@id='select2-js_terminal-type-select2-container']")).click();
					Thread.sleep(T2);
					driver.findElement(By.xpath("//li[normalize-space()='" + var_Terminal_Terminal_Type + "']")).click();
					System.out.println("var_Terminal_Terminal_Type \t\t = " + var_Terminal_Terminal_Type);

					// Field : 124 --> var_Terminal_Device_Model
					Thread.sleep(T3);
					driver.findElement(
							By.xpath("//span[@id='select2-js_device-model-select2-container']")).click();
					Thread.sleep(T2);
					...
					Select Device_owned = new Select(
							driver.findElement(By.xpath("//select[@name='device_owned']")));
					...
					driver.findElement(By.xpath("//input[@name='installation_fee']")).sendKeys(var_Terminal_Installation_Fee);
					...
					Thread.sleep(T3);
					driver.findElement(
							By.xpath("//span[@id='select2-js_rental-plan-select2-container']")).click();
					Thread.sleep(T3);
...
//					System.out.println("var_Terminal_Rental_Threshold = " + var_Terminal_Rental_Threshold);
					...
					driver.findElement(By.xpath("//input[@name='max_usage_daily']")).sendKeys(var_Terminal_Maximum_Usage_Daily);
					System.out.println("var_Terminal_Maximum_Usage_Daily \t = " + var_Terminal_Maximum_Usage_Daily);

					// Field : 133 --> var_Maximum_usage_weekly

					driver.findElement(By.xpath("//input[@name='max_usage_weekly']")).sendKeys(var_Terminal_Maximum_Usage_Weekly);
					...
					driver.findElement(By.xpath("//input[@name='max_usage_montly']")).sendKeys(var_Terminal_Maximum_Usage_Monthly);
					...
					driver.findElement(By.xpath("//input[@name='velocity_check_minutes']")).sendKeys(var_Terminal_Velocity_Check_Minutes);
					System.out.println("var_Terminal_Velocity_Check_Minutes \t = " + var_Terminal_Velocity_Check_Minutes);

					// Field : 136 --> var_Terminal_Velocity_Check_Count

					driver.findElement(By.xpath("//input[@name='velocity_check_count']")).sendKeys(var_Terminal_Velocity_Check_Count);
					...
					Thread.sleep(T3);
					System.out.println(
							"\t< Terminal-Info > POP-UP Status = " + driver.findElement(By.id("swal2-content")).getText());
					driver.findElement(By.xpath("//button[normalize-space()='OK']")).click();
...
//					Thread.sleep(T2);
					...
					//Field :138 --> PAN Card
					Thread.sleep(T2);
					driver.findElement(By.xpath("//input[@name='documents[0][number]']"))
							.sendKeys(var_KYC_PAN_Doc_Num);
					System.out.println("var_KYC_PAN_Doc_Num \t\t\t = " + var_KYC_PAN_Doc_Num);
					driver.findElement(By.xpath("//input[@data-value='PAN Card']")).sendKeys(var_KYC_Proof_Drive_Link + var_KYC_PAN_Proof_Link);
					System.out.println("var_KYC_PAN_Proof_Link \t\t\t = " + var_KYC_Proof_Drive_Link + var_KYC_PAN_Proof_Link);
					...
					driver.findElement(By.xpath("//input[@data-value='Aadhaar']")).sendKeys(var_KYC_Proof_Drive_Link + var_KYC_Aadhar_Proof_Link);
					System.out.println("var_KYC_Aadhar_Proof_Link \t\t = " + var_KYC_Proof_Drive_Link + var_KYC_Aadhar_Proof_Link);
					...
					driver.findElement(By.xpath("//input[@data-value='Cancelled Cheque']")).sendKeys(var_KYC_Proof_Drive_Link + var_KYC_Bank_Cancel_Cheque_Proof_Link);
					System.out.println("var_KYC_Bank_Cancel_Cheque_Proof_Link \t = " + var_KYC_Proof_Drive_Link + var_KYC_Bank_Cancel_Cheque_Proof_Link);
					...
					// POP-UPs : Alert
					Thread.sleep(T3);
					System.out.println("\t< KYC > POP-UP Status = " + driver.findElement(By.id("swal2-content")).getText());
					driver.findElement(By.xpath("//button[normalize-space()='OK']")).click();
